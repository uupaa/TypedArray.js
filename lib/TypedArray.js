...
//}@dev
    ...
    function _markupByArray(num, markup) {
        return markup.indexOf(num) >= 0 ? "font-weight:bold;color:red" : "";
    }
    function _markupByFunction(num, markup) {
        return "color:" + markup(num, markup);
    }
    function _markupByObject(num, markup) {
        if (num in markup) {
